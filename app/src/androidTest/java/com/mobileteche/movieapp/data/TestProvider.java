...
public class TestProvider extends AndroidTestCase {
    ...
    /*
        ...
        Students: Uncomment this test to make sure you've correctly registered the MovieContentProvider.
     */
    ...
    public void testGetType() {
        ...
        String movieId = "76341";
        // content://com.example.android.sunshine.app/weather/94074
        type = mContext.getContentResolver().getType(
                TrailerEntry.buildTrailerMovie(movieId));
        // vnd.android.cursor.dir/com.example.android.sunshine.app/weather
    ...
    public void testBasicTrailerQuery() {
        ...
        TestUtilities.validateCursor("testBasicWeatherQuery", trailerCursor, trailerValues);
    }
   ...
   /* *//*
    ...
    public void testUpdateLocation() {
        ...
        updatedValues.put(MovieEntry.COLUMN_CITY_NAME, "Santa's Village");
    ...
    public void testInsertReadProvider() {
        ...
        // A cursor is your primary interface to the query results.
        Cursor trailerCursor = mContext.getContentResolver().query(
                TrailerEntry.buildTrailerMovie(String.valueOf(movieRowId)),  // Table to Query
                null, // leaving "columns" null just returns all the columns.
                null, // cols for "where" clause
                null, // values for "where" clause
    ...
    public void testDeleteRecords() {
        ...
        mContext.getContentResolver().registerContentObserver(TrailerEntry.CONTENT_URI, true, weatherObserver);
    ...
    public void testBulkInsert() {
        ...
        int insertCount = mContext.getContentResolver().bulkInsert
                (TrailerEntry.buildTrailerMovie(String.valueOf(movieRowId)),
